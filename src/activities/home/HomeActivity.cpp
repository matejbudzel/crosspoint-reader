...
void HomeActivity::loadRecentBooks(int maxBooks) {
  ...
  if (includeRefresh) {
    recentBooks.push_back(
        {REFRESH_DOWNLOAD_SENTINEL_PATH, tr(STR_REFRESH_DOWNLOAD), "", SETTINGS.refreshDownloadImagePath});
  }
...
bool HomeActivity::hasRefreshDownloadSlot() const {
  return SETTINGS.uiTheme == CrossPointSettings::LYRA_3_COVERS && SETTINGS.refreshDownloadUrl[0] != '\0' &&
         SETTINGS.refreshDownloadPath[0] != '\0';
}
