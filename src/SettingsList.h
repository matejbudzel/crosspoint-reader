...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Toggle(StrId::STR_SYNC_TIME_ON_BOOT, &CrossPointSettings::syncTimeOnBoot, "syncTimeOnBoot",
                            StrId::STR_CAT_SYSTEM),
        SettingInfo::Toggle(StrId::STR_CHECK_STALE_SYNC_ON_BOOT, &CrossPointSettings::checkStaleSyncFilesOnBoot,
                            "checkStaleSyncFilesOnBoot", StrId::STR_CAT_SYSTEM),
